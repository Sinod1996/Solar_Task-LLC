...
function Section2(props) {
    ...
    return (
        <div className={'section2'}>
            <div>
                <h3 data-aos={'fade-down'}>Our Services</h3>
                <p data-aos={'fade-up'}>In the budding solar energy sector, we provide solar system design geared towards efficiency. With a <br/>team of seasoned professionals and designs realized all across the US, we aim at delivering a new <br/> standard in detail-oriented planning.</p>
            </div>
